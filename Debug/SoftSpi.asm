...
;	  299+   92 =   391 instructions (  966 byte)

	.type _spi_init,  32
	.dim _spi_init, 1, (_spi_init_function_end&0xFF00)>>8, _spi_init_function_end&0xFF,0,14,0,35 , 1, 1
	.type _Spi_CS_High,  32
	.dim _Spi_CS_High, 1, (_Spi_CS_High_function_end&0xFF00)>>8, _Spi_CS_High_function_end&0xFF,0,36,0,43 , 1, 1
	.type _Spi_CS_Low,  32
	.dim _Spi_CS_Low, 1, (_Spi_CS_Low_function_end&0xFF00)>>8, _Spi_CS_Low_function_end&0xFF,0,44,0,51 , 1, 1
	.type _SPI_Write_2Byte,  32
	.dim _SPI_Write_2Byte, 1, (_SPI_Write_2Byte_function_end&0xFF00)>>8, _SPI_Write_2Byte_function_end&0xFF,0,52,0,70 , 1, 1
	.type _IS31FL3265B_Init,  32
	.dim _IS31FL3265B_Init, 1, (_IS31FL3265B_Init_function_end&0xFF00)>>8, _IS31FL3265B_Init_function_end&0xFF,0,71,0,76 , 1, 1
	.type _Tail_One_Init,  32
	.dim _Tail_One_Init, 1, (_Tail_One_Init_function_end&0xFF00)>>8, _Tail_One_Init_function_end&0xFF,0,77,0,95 , 1, 1
	.type _Tail_Two_Init,  32
	.dim _Tail_Two_Init, 1, (_Tail_Two_Init_function_end&0xFF00)>>8, _Tail_Two_Init_function_end&0xFF,0,96,0,114 , 1, 1
