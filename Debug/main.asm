...
;	  143+   39 =   182 instructions (  442 byte)
	...
	.type _main,  32
	.dim _main, 1, (_main_function_end&0xFF00)>>8, _main_function_end&0xFF,0,12,0,34 , 1, 1
	.type _int_fun0,  32
	.dim _int_fun0, 1, (_int_fun0_function_end&0xFF00)>>8, _int_fun0_function_end&0xFF,0,36,0,53 , 2, 1
	.type _int_fun1,  32
	.dim _int_fun1, 1, (_int_fun1_function_end&0xFF00)>>8, _int_fun1_function_end&0xFF,0,56,0,59 , 2, 1
