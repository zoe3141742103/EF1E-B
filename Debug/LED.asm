...
;; Starting PostCode block
	.def _Tail1_2_Stop_FullWater_Close_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _Tail1_2_Stop_FullWater_Close_function_end, debug, value=$
...
;   STK00
;; Starting PostCode block
	.def _Tail1_2_Stop_BackWater_Close_function_begin, debug, value=$
...
_00211_DS_
	CRET	
	.def _Tail1_2_Stop_BackWater_Close_function_end, debug, value=$
...
;   STK00
;; Starting PostCode block
	.def _Tail2_Stop_FullWater_Open_function_begin, debug, value=$
...
_00195_DS_
	CRET	
	.def _Tail2_Stop_FullWater_Open_function_end, debug, value=$
...
;   STK00
;; Starting PostCode block
	.def _Tail1_FullBackWater_Open_function_begin, debug, value=$
...
_00185_DS_
	CRET	
	.def _Tail1_FullBackWater_Open_function_end, debug, value=$
...
;   STK01
;; Starting PostCode block
	.def _Stop_HighBackWater_Open_function_begin, debug, value=$
...
_00169_DS_
	CRET	
	.def _Stop_HighBackWater_Open_function_end, debug, value=$
...
;   r0x1028
;; Starting PostCode block
	.def _Tail_LowWater_Blinky_function_begin, debug, value=$
...
_00149_DS_
	CRET	
	.def _Tail_LowWater_Blinky_function_end, debug, value=$
...
;   r0x102D
;; Starting PostCode block
	.def _Tail_HighWater_Open_function_begin, debug, value=$
...
_00129_DS_
	CRET	
	.def _Tail_HighWater_Open_function_end, debug, value=$
...
;   STK00
;; Starting PostCode block
	.def _Tail_LowWater_Open_function_begin, debug, value=$
...
_00111_DS_
	CRET	
	.def _Tail_LowWater_Open_function_end, debug, value=$
...
;   STK01
;; Starting PostCode block
	.def _Tail12_Breath_CloseTo10_function_begin, debug, value=$
...
_00097_DS_
	CRET	
	.def _Tail12_Breath_CloseTo10_function_end, debug, value=$
...
;   STK01
;; Starting PostCode block
	.def _Tail12_Breath_Close_function_begin, debug, value=$
...
_00087_DS_
	CRET	
	.def _Tail12_Breath_Close_function_end, debug, value=$
...
;   STK01
;; Starting PostCode block
	.def _Tail12_Breath_Open_function_begin, debug, value=$
...
_00077_DS_
	CRET	
	.def _Tail12_Breath_Open_function_end, debug, value=$
...
;   STK00
;; Starting PostCode block
	.def _Led_Tail_55Open_function_begin, debug, value=$
...
_00045_DS_
	CRET	
	.def _Led_Tail_55Open_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _Led_RT_Water100_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _Led_RT_Water100_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _Led_RT_Water55_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _Led_RT_Water55_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _Led_RT_PWMOpen_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _Led_RT_PWMOpen_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _LED_Stop_PWM10Open_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _LED_Stop_PWM10Open_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _LED_Stop_PWM5Open_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _LED_Stop_PWM5Open_function_end, debug, value=$
...
;	 1837+  604 =  2441 instructions ( 6090 byte)
	...
	.dim _LED_Stop_AllOpen, 1, (_LED_Stop_AllOpen_function_end&0xFF00)>>8, _LED_Stop_AllOpen_function_end&0xFF,0,21,0,25 , 1, 1
	.type _LED_Stop_PWM5Open,  32
	.dim _LED_Stop_PWM5Open, 1, (_LED_Stop_PWM5Open_function_end&0xFF00)>>8, _LED_Stop_PWM5Open_function_end&0xFF,0,26,0,31 , 1, 1
	.type _LED_Stop_PWM10Open,  32
	.dim _LED_Stop_PWM10Open, 1, (_LED_Stop_PWM10Open_function_end&0xFF00)>>8, _LED_Stop_PWM10Open_function_end&0xFF,0,32,0,38 , 1, 1
	.type _LED_Stop_AllClose,  32
	.dim _LED_Stop_AllClose, 1, (_LED_Stop_AllClose_function_end&0xFF00)>>8, _LED_Stop_AllClose_function_end&0xFF,0,39,0,43 , 1, 1
	.type _Led_RT_AllOpen,  32
	.dim _Led_RT_AllOpen, 1, (_Led_RT_AllOpen_function_end&0xFF00)>>8, _Led_RT_AllOpen_function_end&0xFF,0,44,0,49 , 1, 1
	.type _Led_RT_PWMOpen,  32
	.dim _Led_RT_PWMOpen, 1, (_Led_RT_PWMOpen_function_end&0xFF00)>>8, _Led_RT_PWMOpen_function_end&0xFF,0,50,0,55 , 1, 1
	.type _Led_RT_Water55,  32
	.dim _Led_RT_Water55, 1, (_Led_RT_Water55_function_end&0xFF00)>>8, _Led_RT_Water55_function_end&0xFF,0,56,0,63 , 1, 1
	.type _Led_RT_Water100,  32
	.dim _Led_RT_Water100, 1, (_Led_RT_Water100_function_end&0xFF00)>>8, _Led_RT_Water100_function_end&0xFF,0,64,0,71 , 1, 1
	.type _Led_RT_AllClose,  32
	.dim _Led_RT_AllClose, 1, (_Led_RT_AllClose_function_end&0xFF00)>>8, _Led_RT_AllClose_function_end&0xFF,0,72,0,77 , 1, 1
	.type _Led_Tail_AllOpen,  32
	.dim _Led_Tail_AllOpen, 1, (_Led_Tail_AllOpen_function_end&0xFF00)>>8, _Led_Tail_AllOpen_function_end&0xFF,0,78,0,91 , 1, 1
	.type _Led_Tail_55Open,  32
	.dim _Led_Tail_55Open, 1, (_Led_Tail_55Open_function_end&0xFF00)>>8, _Led_Tail_55Open_function_end&0xFF,0,92,0,105 , 1, 1
	.type _Led_Tail_AllClose,  32
	.dim _Led_Tail_AllClose, 1, (_Led_Tail_AllClose_function_end&0xFF00)>>8, _Led_Tail_AllClose_function_end&0xFF,0,106,0,119 , 1, 1
	.type _Tail12_Breath_Open,  32
	.dim _Tail12_Breath_Open, 1, (_Tail12_Breath_Open_function_end&0xFF00)>>8, _Tail12_Breath_Open_function_end&0xFF,0,120,0,129 , 1, 1
	.type _Tail12_Breath_Close,  32
	.dim _Tail12_Breath_Close, 1, (_Tail12_Breath_Close_function_end&0xFF00)>>8, _Tail12_Breath_Close_function_end&0xFF,0,130,0,139 , 1, 1
	.type _Tail12_Breath_CloseTo10,  32
	.dim _Tail12_Breath_CloseTo10, 1, (_Tail12_Breath_CloseTo10_function_end&0xFF00)>>8, _Tail12_Breath_CloseTo10_function_end&0xFF,0,140,0,149 , 1, 1
	.type _Tail_LowWater_Open,  32
	.dim _Tail_LowWater_Open, 1, (_Tail_LowWater_Open_function_end&0xFF00)>>8, _Tail_LowWater_Open_function_end&0xFF,0,150,0,165 , 1, 1
	.type _Tail_HighWater_Open,  32
	.dim _Tail_HighWater_Open, 1, (_Tail_HighWater_Open_function_end&0xFF00)>>8, _Tail_HighWater_Open_function_end&0xFF,0,166,0,185 , 1, 1
	.type _Tail_LowWater_Blinky,  32
	.dim _Tail_LowWater_Blinky, 1, (_Tail_LowWater_Blinky_function_end&0xFF00)>>8, _Tail_LowWater_Blinky_function_end&0xFF,0,186,0,204 , 1, 1
	.type _Stop_HighBackWater_Open,  32
	.dim _Stop_HighBackWater_Open, 1, (_Stop_HighBackWater_Open_function_end&0xFF00)>>8, _Stop_HighBackWater_Open_function_end&0xFF,0,205,0,219 , 1, 1
	.type _Tail1_FullBackWater_Open,  32
	.dim _Tail1_FullBackWater_Open, 1, (_Tail1_FullBackWater_Open_function_end&0xFF00)>>8, _Tail1_FullBackWater_Open_function_end&0xFF,0,220,0,229 , 1, 1
	.type _Tail2_Stop_FullWater_Open,  32
	.dim _Tail2_Stop_FullWater_Open, 1, (_Tail2_Stop_FullWater_Open_function_end&0xFF00)>>8, _Tail2_Stop_FullWater_Open_function_end&0xFF,0,230,0,241 , 1, 1
	.type _Tail1_2_Stop_BackWater_Close,  32
	.dim _Tail1_2_Stop_BackWater_Close, 1, (_Tail1_2_Stop_BackWater_Close_function_end&0xFF00)>>8, _Tail1_2_Stop_BackWater_Close_function_end&0xFF,0,242,1,4 , 1, 1
	.type _Tail1_2_Stop_FullWater_Close,  32
	.dim _Tail1_2_Stop_FullWater_Close, 1, (_Tail1_2_Stop_FullWater_Close_function_end&0xFF00)>>8, _Tail1_2_Stop_FullWater_Close_function_end&0xFF,1,5,1,108 , 1, 1
